...
$sqlFetch = "SELECT * FROM `data` WHERE `year` = '$year' AND `month` = '$month' AND user_id='$user_id' ORDER BY `date` ASC";
...
if ($fetch_result->num_rows > 0) {
    ...
    echo "<td colspan='7' class='text-center'>No data available for $month-$year</td>";
}
