...
<body>
        ...
        <ul>
          <li class="nav-item dropdown">
            <div id="yearNavigator"
              ...
              <ul id="monthDropdown" class="dropdown-menu dropdown-content"
                style="position: absolute; top: 30px; display: none; background: white; border: 1px solid #ccc; padding: 5px; z-index: 1000;">
              </ul>
            </div>
          </li>
          <li><a class='full-text' id="adminBtn" href="admin">Admin Panel</a> <a class='short-text' id="adminBtn"
  ...
  <div class="tdetailsWrapper">
    <div class="tDetails container">
      <div style="background-color: lightgreen;" class="receivedTotal">Received Total:
        <span id="rcvdTotal"> </span>
      </div>
      <div style="background-color: lightgreen;" class="deliveredTotal">Delivered Total:
        <span id="dlvrdTotal"> </span>
      </div>
      <div style="background-color: antiquewhite;" class="cancelTotal">Cancel Total:
        <span id="cancelTotal"> </span>
      </div>
      <div style="background-color: antiquewhite;" class="rescheduledTotal">Rescheduled Total:
        <span id="rescheduledTotal"> </span>
      </div>
      ...
      <div style="background-color: antiquewhite;" class="deliverdRate">Delivered Rate:
        <span id="dlvrdRate"></span>%
      </div>
      <div style="background-color: antiquewhite;" class="returnRate">Return Rate:
        <span id="returnRate"></span>%
      </div>

      <div style="background-color: antiquewhite;" class="returnedTotal">Returned Total:
        <span id="returnTotal"> </span>
      </div>

      <div title="possible total delivery" class="possibleTotal gw">Possible: <span id="posiTotal"> </span>(ps)</div>
      ...
      <div title="Average Delivery" class="avarageDelivery lb">Average Del: <span id="avarDel"> </span></div>

      <div class="avarageTk bg_aqua">Average Incentive: <span id="avarTk"> </span></div>
      <div title="Average total per day" class="avarageTotal bg_aqua">Average: <span id="avarageTotalTk"> </span> (tk)</div>
      <div title="Possible Incentive in month" class="possibleIncome bg_aqua">Possible Incen: <span id="possibleIncome"> </span></div>
